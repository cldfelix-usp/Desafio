        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumeroTitulo = table.Column<string>(type: "TEXT", maxLength: 30, nullable: false),
                    NomeDevedor = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
                    CpfDevedor = table.Column<string>(type: "TEXT", maxLength: 11, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ParcelaId = table.Column<Guid>(type: "TEXT", nullable: false),
                    TituloId = table.Column<Guid>(type: "TEXT", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Parcela_Titulos_TituloId",
                        column: x => x.TituloId,
