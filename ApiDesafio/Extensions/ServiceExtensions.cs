...
using ApiDesafio.Presentation.Controllers;
...
public static class ServiceExtensions
{
    ...
    public static void AddCustomMediaTypes(this IServiceCollection services)
    {
        services.Configure<MvcOptions>(config =>
        {
            ...
            if (systemTextJsonOutputFormatter != null)
            {
                ...
                .Add("application/vnd.desafio.hateoas+json");
                systemTextJsonOutputFormatter.SupportedMediaTypes
                .Add("application/vnd.desafio.apiroot+json");
            }
            ...
            if (xmlOutputFormatter != null)
            {
                ...
                .Add("application/vnd.desafio.hateoas+xml");
                xmlOutputFormatter.SupportedMediaTypes
                .Add("application/vnd.desafio.apiroot+xml");
            }
        });
    }
    ...
    public static void ConfigureVersioning(this IServiceCollection services)
    {
        services.AddApiVersioning(opt =>
        {
         ...
         .AddMvc(opt =>
         {
             opt.Conventions.Controller<TitulosController>()
    ...
    public static void ConfigureSwagger(this IServiceCollection services)
    {
        services.AddSwaggerGen(s =>
        {
            ...
            { 
                Title = "Code Maze API", 
                Version = "v1",
                Description = "ApiDesafio API by desafio",
